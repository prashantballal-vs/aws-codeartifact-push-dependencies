pipeline {
    ...
    environment {
    	...
    	PROJECT_FOLDER = "."
    	AWS_ACCESS_KEY_ID = export AWS_ACCESS_KEY_ID=AKIARYP3FTTYZXSU6KF3
    	AWS_SECRET_ACCESS_KEY = export AWS_SECRET_ACCESS_KEY=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
    	AWS_DEFAULT_REGION = export AWS_DEFAULT_REGION=ap-south-1
    }
